      ...
      <div className="border border-border rounded-lg p-6 bg-card neon-border mb-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            className="flex flex-col items-center gap-2 rounded-lg border border-border bg-secondary p-4 text-foreground transition-transform hover:scale-105 active:scale-95"
          >
